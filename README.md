...
| Лабораторная работа | Название | Основные функции | Ключевые классы/методы |
|:---:|:---|:---|:---|
| **ЛР1-3** | Синтаксический анализ | • Лексический анализ (сканер)<br>• Синтаксический анализ (парсер)<br>• Анализ объявления абстрактного метода C#<br>• Подсветка синтаксиса | `Scanner`, `Parser`, `Token`, `SyntaxError` |
| **ЛР4** | Поиск по регулярным выражениям | • Поиск форматов файлов (.doc, .pdf, .png и др.)<br>• Поиск Биткоин-адресов<br>• Поиск HSL-кодов цветов<br>• Подсветка найденных совпадений | `Regex`, `BtnRegexSearch_Click`, `SearchType` |
| **ЛР5** | Семантический анализ (AST) | • Построение абстрактного синтаксического дерева<br>• Проверка уникальности идентификаторов<br>• Проверка совместимости типов<br>• Проверка допустимых значений<br>• Таблица символов | `AstNode`, `MethodDeclNode`, `SemanticAnalyzer`, `SymbolTable` |
